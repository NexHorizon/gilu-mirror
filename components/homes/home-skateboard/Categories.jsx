...
export default function Categories({ categories }) {
  ...
  const slides = categories.map(cat => ({
    alt: cat.categoryName, title: cat.categoryName, imgSrc: cat.categoryImg?.url ?? "/images/collections/categories-stakeboard1.jpg", count: 8,
    urlName: cat.categoryUrlName
  }))
